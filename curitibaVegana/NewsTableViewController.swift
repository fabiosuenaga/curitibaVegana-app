...
//        self.navigationController?.navigationBar.barTintColor =  UIColor.init(red: 0.25, green: 0.71, blue: 0.18, alpha: 1.0)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if (indexPath as NSIndexPath).row == 0 {
            ...
            cell.postTitleLabel.text = "VegVeg vai mudar de lugar!!"
            cell.authorLabel.text = "Fabio Suenaga"
            cell.authorImageView.image = UIImage(named: "author")

        } else if (indexPath as NSIndexPath).row == 1 {
            cell.postImageView.image = UIImage(named: "custom-segue-featured-1024")
            cell.postTitleLabel.text = "Titulo 2"
            cell.authorLabel.text = "Fabio Suenaga"
            cell.authorImageView.image = UIImage(named: "author")
            
        } else {
            cell.postImageView.image = UIImage(named: "webkit-featured")
            cell.postTitleLabel.text = "Titulo 3"
            cell.authorLabel.text = "Fabio Suenaga"
            cell.authorImageView.image = UIImage(named: "author")
